...
- [ ] 1. Set up project structure, server, and core configuration
  - [ ] 1.1 Create directory structure and package.json
  ...
  - [ ] 1.2 Implement Node.js static server (`server.js`)
  ...
  - [ ]* 1.3 Write property tests for server routing logic
  ...
  - [ ] 1.4 Create module registry (`public/config/modules.json`)
...
- [ ] 2. Implement App Shell and core infrastructure
  - [ ] 2.1 Create App Shell HTML (`public/index.html`)
  ...
  - [ ] 2.2 Implement App Shell styles (`public/css/app-shell.css`)
  ...
  - [ ] 2.3 Implement module registry reader (`public/js/registry.js`)
  ...
  - [ ]* 2.4 Write property test for module registry validation
    - **Property 3: Module registry schema validation**
    - **Validates: Requirements 3.4, 3.5**

  - [ ] 2.5 Implement module router (`public/js/router.js`)
  ...
  - [ ]* 2.6 Write property test for module state round-trip
    - **Property 2: Module state round-trip preservation**
    - **Validates: Requirements 2.4**

  - [ ] 2.7 Implement App Shell initialization (`public/js/app.js`)
...
- [ ] 3. Checkpoint - Ensure App Shell renders correctly
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Implement i18n system
  - [ ] 4.1 Implement i18n manager (`public/js/i18n.js`)
  ...
  - [ ] 4.2 Create translation files for all 6 locales
  ...
  - [ ]* 4.3 Write property tests for i18n system
    - **Property 7: i18n translation completeness**
    - **Property 8: i18n DOM update consistency**
    - **Validates: Requirements 6.1, 6.6**

- [ ] 5. Implement Memory Game Helper module
  - [ ] 5.1 Extract Memory Game Helper into module files
  ...
  - [ ]* 5.3 Write unit tests for Memory Helper module
...
- [ ] 6. Implement Passive Gain Calculator module
  - [ ] 6.1 Create Passive Calc module structure and UI
  ...
  - [ ] 6.2 Implement reward configuration logic
  ...
  - [ ] 6.3 Implement wait time calculation functions
  ...
  - [ ]* 6.6 Write property tests for emerald calculations
    - **Property 12: Emerald availability calculation consistency**
    - **Validates: Requirements 10.4, 10.5, 10.7, 10.8**

  - [ ]* 6.7 Write property test for numeric input validation
    - **Property 9: Numeric input field validation**
    - **Validates: Requirements 8.1, 8.2, 8.3, 8.7, 9.1**

- [ ] 7. Checkpoint - Ensure all modules work correctly
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Integration, sidebar rendering, and final wiring
  - [ ] 8.1 Wire sidebar rendering with module registry
  ...
  - [ ]* 8.2 Write property test for sidebar rendering
    - **Property 1: Sidebar renders all registered modules with name and icon**
    - **Validates: Requirements 1.5, 3.4**

  - [ ]* 8.3 Write integration tests for module loading lifecycle
